...
function Enemy:calculateScore()
  return self.y + (retroEngine.gameHeight - Player.height - Player.y)
end
...
function Enemy:kill()
  ...
  PlayingState.instance.score = math.floor(PlayingState.instance.score + self:calculateScore())
