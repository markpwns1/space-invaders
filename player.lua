...
function Player.verticalAxis()
  ...
  if usingGamepad() then return -joystickAxis("lefty") * math.abs(joystickAxis("lefty")) end
...
function Player.horizontalAxis()
  ...
  if usingGamepad() then return joystickAxis("leftx") * math.abs(joystickAxis("leftx")) end
...
function Player.update(dt)
  ...
  if (key("space") or gamepadPressed()) and Player.canShoot then
